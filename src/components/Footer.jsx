...
function Footer() {
    return (
        <div className=' flex gap-5 w-full h-screen bg-zinc-900 py-20 font-["Founders_Grotesk"]'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className="heading">
                    <h1 className='text-[6vw] font-semibold uppercase leading-none mb-10'>Eye-</h1>
